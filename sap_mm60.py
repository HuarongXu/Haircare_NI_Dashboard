"""
SAP GUI Automation: Run MM60 Report
- 从 code list.xlsx 读取所有 PI FPC codes
- 通过 SAP GUI Scripting 执行 MM60 T-code
- 导出报表为 Excel 并清理空行空列
"""
...
# ============ 可配置 ============
SAP_SAVE_FILENAME = f"PS_Planning_MM60_{date.today().strftime('%Y%m%d')}.xlsx"
# ================================
...
def run_mm60_report():
    print("=" * 50)
    print("SAP MM60 Report Automation")
    print("=" * 50)
